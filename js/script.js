const logo = `
<svg class="img-fluid" width="250" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    ...
                    <div class="collapse navbar-collapse pt-lg-0 pt-3 " id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 gap-3 ">
                            ...
                            <li class="nav-item text-uppercase">
                                <a class="nav-link services" href="./services.html">Services</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link about_us" href="./about_us.html">ABOUT</a>
                            </li>
                            <li class="nav-item">
            ...
            <div class="r-container position-relative">
                <div class="d-flex flex-column justify-content-center align-items-center text-center">
                    ...
                    <div class="d-flex gap-4">
                        ...
                        <a href="https://www.instagram.com/stalwart_prod/" class="font-2 link-social">INSTAGRAM</a>
                    </div>
                </div>
            </div>
        </section>
        <div class="py-3 position-relative bg-secondary-dark container-fluid">
